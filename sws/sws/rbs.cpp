...
void RigidBodySolver::advanceTimestep(float dt, Vector3f* F, Vector3f* r, int N){
	sumExternalForces(F, r, N);
	performEulerIntegration(dt);
	setBodyBox();
}

void RigidBodySolver::sumExternalForces(Vector3f* F, Vector3f* r, int N){
